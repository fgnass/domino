...
Document.prototype = Object.create(ContainerNode.prototype, {
  ...
  createElementNS: { value: function(namespace, qualifiedName) {
    ...
    if (ve.namespace === NAMESPACE.HTML) {
      return html.createElement(this, ve.localName, ve.prefix);
    }
    else if (ve.namespace === NAMESPACE.SVG) {
      return svg.createElement(this, ve.localName, ve.prefix);
    }

    return new Element(this, ve.localName, ve.namespace, ve.prefix);
  }, writable: isApiWritable },

...
Element.prototype = Object.create(Node.prototype, {
  ...
  isHTML: { get: function() {
    return this.namespaceURI === NAMESPACE.HTML &&
  ...
  setAttribute: {value: function setAttribute(qname, value) {
    if (!xml.isValidName(qname)) utils.InvalidCharacter();
    if (this.isHTML) qname = qname.toLowerCase();
    if (qname.substring(0, 5) === 'xmlns') utils.Namespace();
  ...
  _setAttributeNS: { value: function _setAttributeNS(ns, qname, value) {
    ...
    if (!attr) {
      ...
      this._attrKeys = Object.keys(this._attrsByLName);
  ...
  setAttributeNS: { value: function setAttributeNS(ns, qname, value) {
    if (!xml.isValidName(qname)) utils.InvalidCharacter();
    if (!xml.isValidQName(qname)) utils.Namespace();
  ...
  querySelectorAll: { value: function(selector) {
    ...
    return new NodeList(Sizzle(selector, self.parentNode || self));
  }}
...
AttributesArray.prototype = {
  ...
  getNamedItem: function(name) {
    return this.element._attrsByLName['|'+name];
  },
  item: function(n) {

...
function Element(doc, localName, namespaceURI, prefix) {
  ...
  if (namespaceURI !== NAMESPACE.HTML || (!doc.isHTML)) this.isHTML = false;

  if (this.isHTML) {
    var up = uppercaseCache[this.tagName];
    if (!up) {
      // Converting to uppercase can be slow, so cache the conversion.
      uppercaseCache[this.tagName] = up = this.tagName.replace(
...
Attr.prototype = Object.create(Object.prototype, {
  ...
  cloneNode: { value: function cloneNode(deep) {
    var a = new Attr(
      this.ownerElement, this.localName, this.prefix, this.namespaceURI
    );
    a.data = this.data;
    return a;
  }},
...
AttributesArray.prototype = Object.create(Object.prototype, {
  length: { get: function() {

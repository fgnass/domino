...
specialSet[NAMESPACE.HTML] = {
  ...
  "listing":true, "main":true, "marquee":true, "menu":true, "menuitem":true, "meta":true,
...
function HTMLParser(address, fragmentContext, options) {
  ...
  function insertText(s) {
    if (foster_parent_mode && isA(stack.top, tablesectionrowSet)) {
      ...
      if (lastChild && lastChild.nodeType === Node.TEXT_NODE) {
        ...
        stack.top._appendChild(stack.top.ownerDocument.createTextNode(s));
      }
    }
  }
  ...
  function afeclone(doc, i) {
    return createHTMLElt(doc, afe.list[i].localName, afe.attrs[i]);
  }
  ...
  function afereconstruct() {
    ...
    for(i = i+1; i < afe.list.length; i++) {
      var newelt = insertElement(function(doc) { return afeclone(doc, i); });
      afe.list[i] = newelt;
    }
  }
  ...
  function in_head_mode(t, value, arg3, arg4) {
    ...
    case 2: // TAG
      ...
      case "style":
        ...
        return;
      case "script":
        var elt = createHTMLElt(stack.top.ownerDocument, value, arg3);

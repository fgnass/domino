...
Node.prototype = Object.create(EventTarget.prototype, {
  ...
  insertBefore: { value: function insertBefore(child, refChild) {
    ...
    if (refChild.parentNode !== parent) utils.NotFound();
  ...
  removeChild: { value: function removeChild(child) {
    var parent = this;
    if (child.parentNode !== parent) utils.NotFound();
    child.remove();
    return child;
  }},
  ...
  replaceChild: { value: function replaceChild(newChild, oldChild) {
    var parent = this;
    if (oldChild.parentNode !== parent) utils.NotFound();
  ...
  ensureSameDoc: { value: function(that) {
    ...
    if (that.ownerDocument !== ownerdoc) utils.HierarchyRequestError();
  }},
  ...
  serialize: { value: function() {
    ...
    function attrname(a) {
      ...
      case NAMESPACE.XML: return 'xml:' + a.localName;
      case NAMESPACE.XLINK: return 'xlink:' + a.localName;
